...
gulp.task('images', function(tmp) {
    gulp.src(['build/images/*.jpg', 'build/images/*.png'])
...
gulp.task('images-deploy', function() {
    gulp.src(['build/images/**/*', '!build/images/README'])
        //prevent pipe breaking caused by errors from gulp plugins
        .pipe(plumber())
...
gulp.task('scripts', function() {
    ...
    return gulp.src(['build/scripts/src/_includes/**/*.js', 'build/scripts/src/**/*.js'])
                //prevent pipe breaking caused by errors from gulp plugins
                .pipe(plumber())
...
gulp.task('styles', function() {
    ...
    return gulp.src('build/styles/scss/main.scss')
                //prevent pipe breaking caused by errors from gulp plugins
                .pipe(plumber({
...
gulp.task('html-deploy', function() {
    ...
    gulp.src(['build/styles/*.css', '!build/styles/styles.css'])
        //prevent pipe breaking caused by errors from gulp plugins
        .pipe(plumber())
        .pipe(gulp.dest('dist/styles'));
});
...
gulp.task('default', ['browserSync', 'scripts', 'styles'], function() {
    ...
    gulp.watch('build/scripts/src/**', ['scripts']);
